# MonteCarlo Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

MonteCarlo is a Latin (ID: `*Latn`) Handwriting font designed by
[The MonteCarlo Project Team](https://github.com/googlefonts/monte-carlo).
Its design is based on contemporary and traditional beautifully crafted formal
handwriting script.
...
```
Title: MonteCarlo Font
Creators: The MonteCarlo Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-montecarlo
UUID: 9D0C8AE7-330C-4DAB-996B-2B23B0319001
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-montecarlo
```
